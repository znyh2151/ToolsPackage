...
const val VERSION_CODE_REGEX = "(?<=flavor[ \\n]{0,10}\\{[\\s\\S]{0,1000}?versionCode[\\s=]{0,10})\\d+(?=\\s*)"
const val VERSION_NAME_REGEX = "(?<=flavor[ \\n]{0,10}\\{[\\s\\S]{0,1000}?versionName[\\s=]{0,10}\\\").*?(?=\\\")"
const val APPLICATION_ID_REGEX = "(?<=flavor[ \\n]{0,10}\\{[\\s\\S]{0,1000}?applicationId[\\s=]{0,10}\\\").*?(?=\\\")"
